...
export { Sheet, SheetTrigger, SheetClose, SheetContent, SheetDescription, SheetHeader, SheetFooter, SheetTitle }

// Re-exporting empty components for compatibility if needed
